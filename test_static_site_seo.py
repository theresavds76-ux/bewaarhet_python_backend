...
class StaticSiteSeoTests(unittest.TestCase):
    ...
    def test_homepage_has_required_copy_and_visible_faq_structured_data(self) -> None:
        ...
        self.assertIn('magic-inbox-hero-blend-v2.png', html)
        self.assertIn('infographic.png', html)
        self.assertIn('Wij bewaren en organiseren ze automatisch', html)
        self.assertIn('Gewoon via e-mail documenten bewaren en later terugvinden.', html)
